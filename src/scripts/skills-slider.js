const cardsData = [
  ...
  {
    logo: "/icons/sass-logo.svg",
    title: "SASS",
    description: `
      <p>Использую Sass, чтобы писать удобные и понятные стили.</p>
